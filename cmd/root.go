...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.go-codecommit.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".go-codecommit" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".go-codecommit")
	}
